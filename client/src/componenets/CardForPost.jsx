    ...
    const toggleComments = () => {
        if (!show) {
            fetch("/allcomments", {
                ...
                body: JSON.stringify({
                    postId: cardDetails._id
                })
            })
                .then(res => res.json())
                .then((result) => {
                    setAllComments(result[0].comments)
                    console.log(result)
    ...
    return (
        ...
        <div className='card'>
            ...
            <div className='card-header'>
                ...
                <h5>
                    <Link to={`profile/${cardDetails.postedBy._id}`}>
                        {cardDetails.postedBy.userName}
                    </Link>
                </h5>
            </div>
            {/* card image  */}
            ...
            <div className="card-content">
                ...
                <p style={{ fontWeight: "bold", cursor: "pointer" }}
                    onClick={toggleComments} >View all comments</p>
            </div >
            {/* add Comment */}
                ...
                show && (
                    <div className="showComments">
                        <div className="container">
                            ...
                            <div className="details">
                                <div className='card-header' style={{ borderBottom: "1.6px solid #00000029" }} >
                                    ...
                                    <h5>{cardDetails.postedBy.userName}</h5>
                                </div>
                                ...
                                <div className="commentSection" style={{ borderBottom: "1.6px solid #00000029" }} >
                                    ...
                                    {/* <p className="comm">
                                        <span className='commenter'>Ramesh </span>
                                        <span className='commentText'>Ossum pic</span>
                                    </p> */}
                                ...
                                < div className='add-comment' >
                                    ...
                                    <input type="text" placeholder='Add Comment' value={comment} onChange={(e) => setComment(e.target.value)} />
                                    <button className='comment-btn' onClick={() => { makeComment(comment, cardDetails._id); toggleComments(); }} >Post</button>
                                </div >
                        ...
                        <div className="close-comment">
                            {/* &times; */}
                            <span className="material-symbols-outlined material-symbols-outlined-comment" onClick={toggleComments} >close</span>
                        </div>
                    </div>
                )
            }
